...
public class BiometricNextModule extends ReactContextBaseJavaModule {
  private static ReactApplicationContext reactContext;
  private Executor executor;
  String KEYSTORE_PROVIDER_ANDROID = "AndroidKeyStore";

  BiometricNextModule(ReactApplicationContext context) {
    super(context);
